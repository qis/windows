...
Associate "json" "JSON" $editor $text ("json", "json5", "jsonc")
...
Associate "proto" "Protocol Buffers" $editor $text ("proto")
Associate "fbs" "FlatBuffers" $editor $text ("fbs")
...
Associate "def" "Exports" $editor "code.ico" ("def")
...
Associate "makefile" "Makefile" $editor "code.ico" ("mk")
